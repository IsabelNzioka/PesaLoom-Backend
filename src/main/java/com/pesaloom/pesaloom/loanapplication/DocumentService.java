...
import com.pesaloom.pesaloom.exception.DocumentNotFoundException;
import com.pesaloom.pesaloom.exception.DocumentValidationException;
...
import com.pesaloom.pesaloom.loanapplication.entity.Document;
...
import com.pesaloom.pesaloom.loanapplication.storage.DocumentStorage;
...
public class DocumentService {
    ...
    public DocumentDto upload(UUID userId, UUID loanApplicationId, String documentKey, MultipartFile file) {
        ...
        return storeValidated(userId, loanApplicationId, documentKey, file);
    }


    @Transactional
    public DocumentDto uploadForAdmin(UUID shellUserId, UUID loanApplicationId, String documentKey, MultipartFile file) {
        return storeValidated(shellUserId, loanApplicationId, documentKey, file);
    }

    private DocumentDto storeValidated(UUID userId, UUID loanApplicationId, String documentKey, MultipartFile file) {

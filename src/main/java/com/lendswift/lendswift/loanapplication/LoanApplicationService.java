...
import com.lendswift.lendswift.exception.LoanApplicationNotFoundException;
import com.lendswift.lendswift.loanapplication.dto.DocumentDto;
import com.lendswift.lendswift.loanapplication.dto.LoanApplicationDto;
import com.lendswift.lendswift.loanapplication.dto.SaveDraftRequest;
...
import com.lendswift.lendswift.loanapplication.repository.LoanApplicationRepository;
...
public class LoanApplicationService {
    ...
    public LoanApplication getOrCreateDraft(UUID userId) {
        return loanApplicationRepository.findByUserIdAndStatus(userId, LoanApplicationStatus.DRAFT)
                .orElseGet(() -> loanApplicationRepository.save(new LoanApplication(userId)));
    }
